    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="<?php echo base_url(); ?>/adminlte/index2.html"><b> </b></a>
                <img src="<?php echo base_url(); ?>/assets/logo.png" style="width:150px;height:150px;>
            </div>
            <!-- /.login-logo -->
            ...
            <p></p><br>
                ...
                if (empty($status_login)) {
                    $message = "CV. HUTAMA JAYA LESTARI";
                } else {
                ...
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" name="full_name" placeholder="User">
