...
class laporan_gaji extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('Lap_Gaji_model');
    ...
    {
      $countries = $this->Lap_Gaji_model->get_list_countries();
      ...
      $this->template->load('template','laporan/laporan_gaji', $data);
		//$this->load->view('Layout/Template', $data);
	}

  public function ajax_list()
	{
		$list = $this->Lap_Gaji_model->get_datatables();
		$data = array();
		$no = $_POST['start'];
		...
		$output = array(
						"draw" => $_POST['draw'],
						"recordsTotal" => $this->Lap_Gaji_model->count_all(),
						"recordsFiltered" => $this->Lap_Gaji_model->count_filtered(),
						"data" => $data,
				);
    ...
    public function json() {
        ...
        echo $this->Lap_Gaji_model->json();
    }

    public function read($id)
    {
        $row = $this->Lap_Gaji_model->get_by_id($id);
        if ($row) {
            $data = array(
    ...
    public function create_action()
    {
		...
		'potongan_terlambat' => $this->input->post('potongan_terlambat',TRUE),
            ...
            $this->Lap_Gaji_model->insert($data);
    ...
    public function update_action()
    {
		...
		'potongan_terlambat' => $this->input->post('potongan_terlambat',TRUE),
            ...
            $this->Lap_Gaji_model->update($this->input->post('kode_absen', TRUE), $data);
    ...
    public function form(){
		...
		if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
			// lakukan upload file dengan memanggil function upload yang ada di Lap_Gaji_model.php
			$upload = $this->Lap_Gaji_model->upload_file($this->filename);
	...
	public function import(){
		...
		$this->Lap_Gaji_model->insert_multiple($data);
