...
function datalist_dinamis($name,$table,$field,$key,$value=null){
    $ci = get_instance();
...
function rename_string_aktif($string){
        return $string=='1'?'Aktif':'Tidak Aktif';
    }

function rename_string_kawin($string){
        return $string=='1'?'Kawin':'Tidak Kawin';
    }
